...
Módulo....: Controle de Gastos Diários em um E-commerce
Data......: 14 de agosto de 2025
Autor.....: Macedo, Glener Diniz
Descrição.: Neste módulo desenvolvemos um sistema simples para um e-commerce que deseja registrar os valores das compras 
            realizadas por um cliente ao longo de um único dia. 
            O sistema deve primeiro receber a quantidade total de compras realizadas e, em seguida, solicitar o valor de 
            cada uma dessas compras. Ao final, o sistema deve exibir o total gasto no dia e a média de valor por compra.

Entrada...: A entrada deve receber:
...
Saída.....: O programa deverá retornar:
